...
.btn-acessar-plataforma {
  ...
  max-width: 200px; /* adicione essa linha para limitar a largura do botão */
  margin-top: 20px
...
#outroTexto {
   position: relative;
  top: 480px; /* ou outro valor, conforme necessário */
}
...
#logo {
  ...
  justify-content: center;
    ...
    <body id="page-top">
        <!-- Masthead-->
        <header class="masthead text-white text-center" style="background-repeat: no-repeat; background-size: cover;background-image: url(images/IMG_1957.png)">
            <div class="container d-flex align-items-center flex-column">
                ...
                <div id="link" align="center"></div>
                                <div class="col-12 col-md-6 col-lg-12">
                  <a href="https://ds.brasil777bet.com/?gfs=q9q3tyaq" class="btn btn-success" target="_blank">Cadastre-se Para Jogar</a>
                  <button id="gerarBtn" class="btn btn-primary"><img src="images/hack.svg" width="18" height="18"> Gerar Hacker</button>
                </div>
